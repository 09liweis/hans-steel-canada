...
const PrivacyPolicy: NextPage = () => {
  return (
    <>
      <Head>
        <title>Privacy Policy — Hans Steel Canada</title>
      </Head>
            ...
            <div className="prose prose-lg max-w-none text-gray-700">
              ...
              <section className="mb-8">
                ...
                <p className="leading-relaxed mb-4">
                  Hans Steel Canada ("we," "our," or "us") is committed to protecting your privacy. This Privacy Policy explains how we collect, use, disclose, and safeguard your information when you visit our website or use our services.
                </p>
                <p className="leading-relaxed">
                  Please read this Privacy Policy carefully. By accessing or using our website, you agree to be bound by the terms described herein. If you do not agree with the terms of this Privacy Policy, please do not access or use our services.
                </p>
              </section>
              ...
              <section className="mb-8">
                ...
                <h3 className="text-xl font-semibold text-gray-800 mb-3 mt-6">Financial Data</h3>
                <p className="leading-relaxed">
                  Financial information, such as data related to your payment method that we may collect when you purchase, order, return, exchange, or request information about our services from the website. We store only very limited, if any, financial information that we collect.
                </p>
              </section>
              ...
              <section className="mb-8">
                ...
                <h3 className="text-xl font-semibold text-gray-800 mb-3 mt-6">By Law or to Protect Rights</h3>
                <p className="leading-relaxed mb-4">
              ...
              <section className="mb-8">
                <h2 className="text-2xl font-semibold text-gray-900 mb-4">Policy for Children</h2>
                <p className="leading-relaxed">
